...
do_fixed_horizon_local_forecasting("cif_2016", "stl", "cif_2016_dataset.tsf")
do_fixed_horizon_local_forecasting("nn5_daily", "stl", "nn5_daily_dataset_without_missing_values.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("tourism_yearly", "stl ", "tourism_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("tourism_quarterly", "stl ", "tourism_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("tourism_monthly", "stl", "tourism_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m1_yearly", "stl", "m1_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m1_quarterly", "stl", "m1_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m1_monthly", "stl", "m1_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m3_yearly", "stl", "m3_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m3_quarterly", "stl", "m3_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m3_monthly", "stl", "m3_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m3_other", "stl", "m3_other_dataset.tsf")
do_fixed_horizon_local_forecasting("m4_yearly", "stl ", "m4_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m4_quarterly", "stl", "m4_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m4_monthly", "stl", "m4_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m4_weekly", "stl", "m4_weekly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m4_daily", "stl", "m4_daily_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("m4_hourly", "stl", "m4_hourly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_local_forecasting("kaggle_web_traffic_daily", "stl", "kaggle_web_traffic_dataset_without_missing_values.tsf", "series_name", "start_timestamp", NULL, TRUE)
...
do_fixed_horizon_local_forecasting("car_parts", "stl", "car_parts_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 12, TRUE)
do_fixed_horizon_local_forecasting("hospital", "stl", "hospital_dataset.tsf", "series_name", "start_timestamp", 12, TRUE)
do_fixed_horizon_local_forecasting("fred_md", "stl", "fred_md_dataset.tsf", "series_name", "start_timestamp", 12)
...
do_fixed_horizon_local_forecasting("nn5_weekly", "stl", "nn5_weekly_dataset.tsf", "series_name", "start_timestamp", 8)
do_fixed_horizon_local_forecasting("traffic_weekly", "stl", "traffic_weekly_dataset.tsf", "series_name", "start_timestamp", 8)
do_fixed_horizon_local_forecasting("electricity_weekly", "stl", "electricity_weekly_dataset.tsf", "series_name", "start_timestamp", 8, TRUE)
do_fixed_horizon_local_forecasting("solar_weekly", "stl", "solar_weekly_dataset.tsf", "series_name", "start_timestamp", 5)
do_fixed_horizon_local_forecasting("kaggle_web_traffic_weekly", "stl", "kaggle_web_traffic_weekly_dataset.tsf", "series_name", "start_timestamp", 8, TRUE)
do_fixed_horizon_local_forecasting("dominick", "stl", "dominick_dataset.tsf", NULL, NULL, 8)
...
do_fixed_horizon_local_forecasting("us_births", "stl", "us_births_dataset.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_local_forecasting("saugeen_river_flow", "stl", "saugeenday_dataset.tsf", "series_name", "start_timestamp", 30)
do_fixed_horizon_local_forecasting("sunspot", "stl", "sunspot_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_local_forecasting("covid_deaths", "stl", "covid_deaths_dataset.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_local_forecasting("weather", "stl", "weather_dataset.tsf", NULL, NULL, 30)
do_fixed_horizon_local_forecasting("bitcoin", "stl", "bitcoin_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 30)
do_fixed_horizon_local_forecasting("vehicle_trips", "stl", "vehicle_trips_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_local_forecasting("temperature_rain", "stl", "temperature_rain_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 30)
...
do_fixed_horizon_local_forecasting("traffic_hourly", "stl", "traffic_hourly_dataset.tsf", "series_name", "start_timestamp", 168)
do_fixed_horizon_local_forecasting("electricity_hourly", "stl", "electricity_hourly_dataset.tsf", "series_name", "start_timestamp", 168, TRUE)
do_fixed_horizon_local_forecasting("solar_10_minutes", "stl", "solar_10_minutes_dataset.tsf", "series_name", "start_timestamp", 1008)
do_fixed_horizon_local_forecasting("kdd_cup", "stl", "kdd_cup_2018_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 168)
do_fixed_horizon_local_forecasting("melbourne_pedestrian_counts", "stl", "pedestrian_counts_dataset.tsf", "series_name", "start_timestamp", 24, TRUE)
do_fixed_horizon_local_forecasting("aus_elecdemand", "stl", "australian_electricity_demand_dataset.tsf", "series_name", "start_timestamp", 336)
do_fixed_horizon_local_forecasting("rideshare", "stl", "rideshare_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 168)
